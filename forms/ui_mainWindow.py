...
class Ui_ControlPanel(object):
    def setupUi(self, ControlPanel):
        ...
        icon6 = QIcon()
        icon6.addFile(u"../resources/assets/pen-tool.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon11 = QIcon()
        icon11.addFile(u"../resources/assets/file-text.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btnWorksorder.setIcon(icon11)
        ...
        icon12 = QIcon()
        icon12.addFile(u"../resources/assets/compass.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btnTimesheets.setIcon(icon12)
        ...
        icon13 = QIcon()
        icon13.addFile(u"../resources/assets/users.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btnResources.setIcon(icon13)
        ...
        icon14 = QIcon()
        icon14.addFile(u":/icons/icons/upload-cloud.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btnUploadWO.setIcon(icon14)
        ...
        self.lbCustomerPage.setGeometry(QRect(220, 30, 721, 31))
...
"}")
        ...
        icon15 = QIcon()
        icon15.addFile(u":/icons/icons/zoom-in.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        self.label_19.setGeometry(QRect(370, 30, 421, 31))
...
"}")
        ...
        self.searchBtn_2.setIcon(icon15)
...
"}")
        ...
        self.lePosition.setGeometry(QRect(10, 340, 221, 31))
...
"}")
        ...
        self.cbCompany.setGeometry(QRect(10, 220, 221, 31))
...
"")
        ...
        self.lbFirstName_10 = QLabel(self.customerCRUD_2)
        self.lbFirstName_10.setObjectName(u"lbFirstName_10")
        self.lbFirstName_10.setGeometry(QRect(10, 20, 121, 20))
        self.lbFirstName_10.setFont(font)
        self.leContactID = QLineEdit(self.customerCRUD_2)
        self.leContactID.setObjectName(u"leContactID")
        self.leContactID.setGeometry(QRect(10, 40, 221, 31))
        self.leContactID.setFont(font4)
        self.leContactID.setStyleSheet(u"QLineEdit {\n"
" border: 1px solid gray;\n"
" border-radius: 10px;\n"
"}")
        ...
        self.label_16.setGeometry(QRect(370, 30, 421, 31))
...
"     }")
        ...
        self.label_17.setGeometry(QRect(370, 30, 421, 31))
...
"     }")
        ...
        self.label_18.setGeometry(QRect(370, 30, 421, 31))
...
"}")
        ...
        self.searchBtn_3.setIcon(icon15)
...
"     }")
        ...
        self.label_21.setGeometry(QRect(200, 30, 741, 21))
        ...
        self.label_22.setGeometry(QRect(290, 30, 571, 31))
        ...
        icon16 = QIcon()
        icon16.addFile(u"../../../../Users/Gerald Holt/.designer/resources/assets/corner-down-right.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btnDesignBasis.setIcon(icon16)
        ...
        self.btnSiteConditions.setIcon(icon16)
        ...
        self.btnDesignCriteria.setIcon(icon16)
        ...
        self.btnBuildinList.setIcon(icon16)
        ...
        self.btnStructureList.setIcon(icon16)
        ...
        self.btnGenSpec.setIcon(icon16)
        ...
        self.btnBuildSpec.setIcon(icon16)
        ...
        self.btnBuildBOM.setIcon(icon16)
        ...
        self.btnBuildBOE.setIcon(icon16)
        ...
        self.btnConveyorSchedule.setIcon(icon16)
        ...
        self.btnMechDataSheet.setIcon(icon16)
        ...
        self.btnBuildDrg.setIcon(icon16)
        ...
        self.btnBuildCalc.setIcon(icon16)
        ...
        self.btnStrucCalc.setIcon(icon16)
        ...
        self.btnStrucDrg.setIcon(icon16)
        ...
        self.btnStructCalc.setIcon(icon16)
        ...
        self.btnStrucSpec.setIcon(icon16)
        ...
        self.btnMechSpec.setIcon(icon16)
        ...
        self.btnMechCalc.setIcon(icon16)
        ...
        self.btnCivlDrg.setIcon(icon16)
        ...
        self.btnDCivilsList.setIcon(icon16)
        ...
        self.btnCivilSpec.setIcon(icon16)
        ...
        self.btnCivilBOM.setIcon(icon16)
        ...
        self.btnCivilCalc.setIcon(icon16)
        ...
        self.btnTenderQuotes.setIcon(icon16)
        ...
        self.btnTenderSOW.setIcon(icon16)
        ...
        self.btnCivilSpec_2.setIcon(icon16)
        ...
        self.btnDCivilsList_2.setIcon(icon16)
        ...
        self.btnCivilSpec_3.setIcon(icon16)
...
"}")
    ...
    def retranslateUi(self, ControlPanel):
        ...
        self.lbFirstName_10.setText(QCoreApplication.translate("ControlPanel", u"Contact ID", None))
