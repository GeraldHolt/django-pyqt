...
class Ui_ControlPanel(object):
    def setupUi(self, ControlPanel):
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/icons/smile.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.btnDashboard.setGeometry(QRect(10, 0, 51, 41))
        sizePolicy1 = QSizePolicy(QSizePolicy.Minimum, QSizePolicy.Minimum)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.btnDashboard.sizePolicy().hasHeightForWidth())
        self.btnDashboard.setSizePolicy(sizePolicy1)
        font1 = QFont()
        ...
        self.btnCalculation.setIcon(icon4)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icons/icons/check-square.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btnProcurement.setIcon(icon6)
        ...
        self.btnAnalysis.setIcon(icon7)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/icons/icons/layers.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btnDocControl.setIcon(icon8)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/icons/icons/layout.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btnInvoices.setIcon(icon9)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/icons/icons/table.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btnWorksorder.setIcon(icon10)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/icons/icons/compass.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/icons/icons/users.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.label.setPixmap(QPixmap(u"Z:/__CUSTOMER LOGOS/HCE-C.png"))
        ...
        icon13 = QIcon()
        icon13.addFile(u":/icons/icons/upload-cloud.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.label_14.setGeometry(QRect(400, 30, 421, 20))
        ...
        self.lbCustomerPage.setGeometry(QRect(370, 30, 421, 20))
...
"}")
        ...
        self.label_19.setGeometry(QRect(370, 30, 421, 20))
...
"")
        ...
        self.label_16.setGeometry(QRect(370, 30, 421, 20))
...
"     }")
        ...
        self.label_22.setGeometry(QRect(290, 30, 571, 20))
        ...
        self.tabDoccontrol.setGeometry(QRect(10, 70, 1221, 761))
        self.tab_5 = QWidget()
        ...
        self.label_23.setGeometry(QRect(260, 30, 571, 20))
        ...
        self.label_24.setGeometry(QRect(290, 30, 571, 20))
        ...
        self.label_25.setGeometry(QRect(290, 30, 571, 20))
...
"}")
        ...
        self.tabDoccontrol.setCurrentIndex(1)
        self.tabTechData.setCurrentIndex(1)
