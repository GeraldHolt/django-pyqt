...
class Company(models.Model):
    ...
    date_latest_quote   = models.DateField(blank=True, null = True, verbose_name = 'Latest Quotation')
    date_latest_order   = models.DateField(blank=True, null = True, verbose_name = 'Latest Order')
    ...
    companyWeb          = models.URLField(blank=True, null=True, verbose_name = 'Company Website' )
    ...
    companyEmail        = models.EmailField(blank=True, null=True, verbose_name = 'Company Email')
